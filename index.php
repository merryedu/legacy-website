    ...
    <div class="wrapper">
        ...
        <div id="main">
            ...
            <section id="primary" class="content-full-width">
                ...
                <div class="container">
                    ...
                    <div class="dt-sc-one-fourth column first">
                        <div class="dt-sc-ico-content type1">
                            ...
                            <h4><a href="">优秀的老师</a></h4>
                            <p>我们的教师大多是名校毕业，并且经过前后多轮选拔和培训，有着丰富的教学经验，深受广大家长好评。</p>
                        </div>
                    </div>
                    ...
                    <div class="dt-sc-one-fourth column">
                        <div class="dt-sc-ico-content type1">
                            ...
                            <h4><a href="">就近的教学点</a></h4>
                            <p>我们会尽量选择合适的教学点，为家长和孩子提供最大的便利。</p>
                        </div>
                    </div>
                    ...
                    <div class="dt-sc-one-fourth column">
                        <div class="dt-sc-ico-content type1">
                            ...
                            <h4><a href="">更少的班级人数</a></h4>
                            <p>我们的一、二年级班级人数不超过10人，三年级以上班级人数不超过15人，这样能够达到更好的课堂效果，让老师能够关注每位学生的学习和成长。我们鼓励家长随堂听课，如果不满意还可以退费，我们一直坚持这一原则。成就学生和家长是我们的宗旨。</p>
                        </div>
                    </div>
                    ...
                    <div class="dt-sc-one-fourth column">
                        <div class="dt-sc-ico-content type1">
                            ...
                            <h4><a href="">更高效的课堂节奏和学习效率</a></h4>
                            <p>我们致力于提高学生的学习效率，节省孩子和家长的宝贵时间是我们的目标。</p>
                        </div>
                    </div>
                        ...
                        <div class="dt-sc-one-half column first">
                            ...
                            <div class="dt-sc-one-half column first">
                                ...
                                <div class="dt-sc-ico-content type2">
                                    ...
                                    <h4><a href="#" target="_blank"> 课前检测 </a></h4>
                                    <p>通过课前检测可以反映出哪些问题哪些学生掌握了,哪些问题学生掌握得还不好,然后根据反馈的情况调控自己的教学内容和进度,在课堂上尽量做到“多引导,少讲解”,充分发挥和调动学生的主观能动性,提高课堂教学的有效性。</p>
                                </div>
                                ...
                                <div class="dt-sc-ico-content type2">
                                    ...
                                    <h4><a href="#" target="_blank"> 教学铺垫 </a></h4>
                                    <p>"铺垫"是教师有意识地为学生的后续学习做好准备，形成学生合理认识知识结构的一种教学艺术。对课堂教学起承上启下，攻克难点起积极作用，也是提高课堂教学效率一种行之有效的方法。</p>
                                </div>
                                <div class="dt-sc-hr-very-small"></div>
                                <div class="dt-sc-ico-content type2">
                                    <div class="icon">
                                    ...
                                    <h4><a href="#" target="_blank"> 精选例题 </a></h4>
                                    <p>高度抽象性是数学的特点之一, 而这种抽象逻辑思维在很大程度上仍然是直接与感性经验相联系的,仍然具有很大成分的具体形象性,因此他们对于抽象的数学知识的掌握往往总是先通过许多具体的、直观的例题讲解与练习然后逐步加深理解的. 恰到好处的精选例题不但可以直达数学问题本质，而且可以减轻学生负担。</p>
                                </div>
                            ...
                            <div class="dt-sc-one-half column">
                                ...
                                <div class="dt-sc-ico-content type2">
                                    ...
                                    <h4><a href="#" target="_blank"> 注意力引导 </a></h4>
                                    <p>低年级的学生年龄小，注意力难控制，因此注意力引导就显得特别重要。明睿的老师会通过生动活泼的课堂激发小朋友学习兴趣，并特别注重引导小朋友的注意力。</p>
                                </div>
                                <div class="dt-sc-hr-very-small"></div>
                                <div class="dt-sc-ico-content type2">
                                    <div class="icon">
                                    ...
                                    <h4><a href="#" target="_blank"> 开拓思维 </a></h4>
                                    <p>为了充分挖掘孩子的学习潜力，开拓思维与创新，我们投入很大的精力在思维开拓性问题上，引导小朋友主动思考。</p>
                                </div>
                                <div class="dt-sc-hr-very-small"></div>
                                <div class="dt-sc-ico-content type2">
                                    <div class="icon">
                                    ...
                                    <h4><a href="#" target="_blank"> 知识点回顾和总结 </a></h4>
                                    <p>总结不仅能帮助学生理顺知识结构，突出重点，突破难点，而且能够与课堂所学形成整体与局部的对照，帮助学生更深入和宏观掌握课堂所学内容。</p>
                                </div>
                ...
                <!--container starts-->
                <div class="container">
                    <h2 class="dt-sc-hr-green-title">学习在明睿</h2>
                    ...
                    <div class="front-portfolio-container">
                           ...
                           <div class="front-portfolio">
                              <div class="portfolio-outer">
                                  <div class="portfolio-thumb">
                                  	  <img src="images/door.jpg" alt="" title="">
                                      <div class="image-overlay">
                                        <h5><a href="portfolio-detail.php">前台</a></h5>
                                        <a href="portfolio-detail.php" class="link"><span class="fa fa-link"></span></a>
                                        <a href="images/door.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                  </div>
                              </div>
                           </div>
                       ...
                       <div class="portfolio-content portfolio-content2">
                           <div class="front-portfolio">
                              <div class="portfolio-outer">
                                  <div class="portfolio-thumb">
                                  	  <img src="images/books.jpg" alt="" title="">
                                      <div class="image-overlay">
                                        <h5><a href="portfolio-detail.php">课本</a></h5>
                                        <a href="portfolio-detail.php" class="link"><span class="fa fa-link"></span></a>
                                        <a href="images/books.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                  </div>
                              </div>
                           </div>
                       ...
                       <div class="portfolio-content portfolio-content3">
                           <div class="front-portfolio">
                              <div class="portfolio-outer">
                                  <div class="portfolio-thumb">
                                      <img src="images/classroom.jpg" alt="" title="">
                                      <div class="image-overlay">
                                        <h5><a href="portfolio-detail.php">教室</a></h5>
                                        <a href="portfolio-detail.php" class="link"><span class="fa fa-link"></span></a>
                                        <a href="images/classroom.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                  </div>
                              </div>
                           </div>
                           ...
                           <div class="front-portfolio">
                              <div class="portfolio-outer">
                                  <div class="portfolio-thumb">
                                      ...
                                      <div class="image-overlay">
                                        <h5><a href="portfolio-detail.php">卡片</a></h5>
                                        <a href="portfolio-detail.php" class="link"><span class="fa fa-link"></span></a>
                                        <a href="images/cards.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                  </div>
                              </div>
                           </div>
                       ...
                       <div class="portfolio-content portfolio-content5">
                           <div class="front-portfolio">
                              <div class="portfolio-outer">
                                  <div class="portfolio-thumb">
                                      <img src="images/giftbook.jpg" alt="" title="">
                                      <div class="image-overlay">
                                        <h5><a href="portfolio-detail.php">书籍和礼物</a></h5>
                                        <a href="portfolio-detail.php" class="link"><span class="fa fa-link"></span></a>
                                        <a href="images/giftbook.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                  </div>
                              </div>
                           </div>
                       ...
                       <div class="portfolio-content portfolio-content6">
                           <div class="front-portfolio">
                              <div class="portfolio-outer">
                                  <div class="portfolio-thumb">
                                      <img src="images/gifts.jpg" alt="" title="">
                                      <div class="image-overlay">
                                        <h5><a href="portfolio-detail.php">礼品</a></h5>
                                        <a href="portfolio-detail.php" class="link"><span class="fa fa-link"></span></a>
                                        <a href="images/gifts.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                  </div>
                              </div>
                           </div>
                       ...
                       <div class="portfolio-content portfolio-content7">
                           <div class="front-portfolio">
                              <div class="portfolio-outer">
                                  <div class="portfolio-thumb">
                                      <img src="images/giftroom.jpg" alt="" title="">
                                      <div class="image-overlay">
                                        <h5><a href="portfolio-detail.php">礼品室</a></h5>
                                        <a href="portfolio-detail.php" class="link"><span class="fa fa-link"></span></a>
                                        <a href="images/giftroom.jpg" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                    </div>
                                  </div>
                              </div>
                           </div>
                       ...
                       <div class="aligncenter">
                           <a href="#" class="dt-sc-button medium mustard"> 点击查看所有 <span class="fa fa-chevron-circle-right"> </span></a>
                       </div>
                    </div>
                ...
                <section class="fullwidth-background dt-sc-parallax-section orange-bg">
                    <!--container starts-->
                    <div class="container">
                        <h2 class="dt-sc-hr-white-title">最近的博客</h2>
                        <div class="column dt-sc-one-half first">
                            <article class="blog-entry">
                                <div class="blog-entry-inner">
                                    <div class="entry-meta">
                                        <a href="blog-detail.php" class="blog-author"><img src="http://placehold.it/90x90" alt="" title=""></a>
                                        <div class="date">
                                            <span> 27 </span>
                                            <p> 8月 <br> 2014 </p>
                                        </div>
                                    ...
                                    <div class="entry-thumb">
                                        <a href="blog-detail.php"><img src="images/blog_img1.jpg" alt="" title=""></a>
                                    </div>
                                    <div class="entry-details">
                                        <div class="entry-title">
                                            <h3><a href="blog-detail.php"> 每个优秀孩子背后都有一个用心的家长 </a></h3>
                                        </div>
                                        <!--entry-metadata ends-->
                                        <div class="entry-body">
                                            <p>因为经常和班上的家长沟通，很有幸结识了很多牛家长。这些孩子不但有好的学习成绩，还都拥有良好的学习习惯、阳光的性格，甚至是多才多艺、爱好广泛。每个孩子在成长的过程中，都会遇到各种各样的问题。学习习惯不好、学习成绩不好、脾气大、顶嘴……</p>
                                        </div>
                                        <a href="blog-detail.php" class="dt-sc-button small"> 更多 <span class="fa fa-chevron-circle-right"> </span></a>
                                    </div>
                                </div>
                            </article>
                        </div>
                        ...
                        <div class="column dt-sc-one-half">
                            <article class="blog-entry">
                                <div class="blog-entry-inner">
                                    ...
                                    <div class="entry-thumb">
                                        <a href="blog-detail.php"><img src="http://placehold.it/1170x711" alt="" title=""></a>
                                    </div>
                                    <div class="entry-details">
                                        <div class="entry-title">
                                            <h3><a href="blog-detail.php"> 下一代成长 </a></h3>
                                        </div>
                                        <!--entry-metadata ends-->
                                        <div class="entry-body">
                                            <p>Coming soon...</p>
...
<?php include( "partials/teachers_columns.php" ); ?>
                ...
                <section class="fullwidth-background dt-sc-parallax-section product_bg">
                    <!--container starts-->
                    <div class="container">
                        <h2 class="dt-sc-hr-white-title">最近的课程</h2>
                        <ul class="products">
                            ...
                            <li class="dt-sc-one-fourth column">
                                ...
                                <div class="product-details">
                                    ...
                                    <span class="price"> ￥170.00 / 次 </span>
                                </div>
                            </li>
                            <li class="dt-sc-one-fourth column">
                                <div class="product-thumb">
                                ...
                                <div class="product-details">
                                    ...
                                    <span class="price"> ￥210.00 / 次 </span>
                                </div>
                            </li>
                            <li class="dt-sc-one-fourth column">
                                <div class="product-thumb">
