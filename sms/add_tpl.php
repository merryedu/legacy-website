...
$tpl_content = $_POST['tpl_content'];; //请用自己的手机号代替
echo add_tpl($apikey,$tpl_content);
...
* mobile 为接受短信的手机号
*/
function add_tpl($apikey, $tpl_content){
   $url="http://yunpian.com/v1/tpl/add.json";
   $encoded_text = urlencode("$tpl_content");
   $post_string="apikey=$apikey&tpl_content=$encoded_text";
